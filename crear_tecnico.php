	                    ...
	                    <div class="col-md-10">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">Agregar Técnico</h4>
									<p class="category">Rellena los campos</p>
	                            </div>
	                            <div class="card-content">
	                                <form method="POST" action="guardar_tecnico.php" >
									...
									<input type="text" class="form-control" rows="2" name="correo" required>
	                                    ...
	                                    <button type="submit" class="btn btn-primary pull-right">Guardar Técnico<br><i class="material-icons">send</i></button>
